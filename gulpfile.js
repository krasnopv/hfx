...
function watchFiles() {
  ...
  watch('src/assets/video/**/*', copyVideos);
}
...
// DEVELOPMENT
exports.development = series(cleanDist, copyFont, copyImages, copyVideos, compileHTML, compileSCSS, cssVendor, jsVendor, compileJS, resetPages, prettyHTML,  browserSyncInit, watchFiles);

// PRODUCTION
exports.production = series(cleanDist, copyFont, copyImages, copyVideos, compileHTML, compileSCSS, cssVendor, purgeCSS, minifyCSS, jsVendor, concatScripts, minifyScripts, renameSources, prettyHTML, generateDocs, browserSyncInit);
